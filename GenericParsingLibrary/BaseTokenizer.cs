...
namespace GenericParsingLibrary
{
    ...
    public class BaseTokenizer : AbstractTokenizer
    {
        ...
        /// </summary>
        public virtual Dictionary<string, Action<BaseTokenizer>> CustomHandlers { get; set; } = new();
        public override List<GenericToken> Tokens { get; protected set; } = new();
        public override GenericToken? LastToken { get; private set; }
