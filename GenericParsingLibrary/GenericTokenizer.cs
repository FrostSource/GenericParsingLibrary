...
public class GenericTokenizer : BaseTokenizer
{
    ...
    protected char CurrentChar
    {
        get
        {
            return Index < 0 || Index >= Source.Length ? '\0' : Source[Index];
        }
    }
    /// <summary>
    ...
    protected char NextChar
    {
        get
        {
            return Index < -1 || Index >= Source.Length - 1 ? '\0' : Source[Index + 1];
        }
    }
    /// <summary>
    ...
    {
        return str != "" && str.Length <= Source.Length - Index && Source.Substring(Index, str.Length) == str;
    }
    /// <summary>
    ...
    protected virtual string NextWord(string expecting = "", string? boundaryChars = null, string? invalidChars = null, string? validChars = null, bool failOnEmpty = true, bool allowWhiteSpace = false, bool? allowEscaping = null)
    {
        ...
        return failOnEmpty && str.Length == 0 ? throw SyntaxError($"Expecting {expecting}") : str.ToString();
    }
    /// <summary>
    ...
    protected virtual string NextDecimal(char? decimalChar = null)
    {
        ...
        var decimalPre = NextWord("decimal number", BoundaryChars + decimalChar, validChars: DigitChars);
        var decimalPost = "";
    ...
    protected virtual string NextSequence(string validStartChars, string validChars)
    {
        ...
        var sequence = CurrentChar.ToString();
        Advance();
